...
# IoT with AWS IoT
I am going to do my best to explain core concepts of internet of things in the context of an industrial setting and AWS IoT. 
### Things
...
The Raspberry is still simulating a microcontroller that will query the but instead of just publishing the result, it will update the Shadow document of the Thing.<br><br>
